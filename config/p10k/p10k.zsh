...
# Generated by Powerlevel10k configuration wizard on 2021-10-02 at 14:27 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$DARCULA_GREEN
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$DARCULA_ORANGE
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$DARCULA_ORANGE
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%'${DARCULA_GREEN}'F'   # green foreground
  ...
  typeset -g POWERLEVEL9K_ASDF_HASKELL_FOREGROUND=$DARCULA_ORANGE
  ...
  ##########[ haskell_stack: haskell version from stack (https://haskellstack.org/) ]###########
  # Haskell color.
  typeset -g POWERLEVEL9K_HASKELL_STACK_FOREGROUND=$DARCULA_ORANGE
